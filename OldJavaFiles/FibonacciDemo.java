...
public class FibonacciDemo {
	...
	else if(fibArray[(int) num] != 0)
	{
		return fibArray[(int) num];
	}
	else
	{
		long fibValue = memoizedFibonacci(num - 1) + memoizedFibonacci(num - 2);
    ...
    return((long)((Math.pow(phi,num)-Math.pow(1-phi,num))/Math.sqrt(5)));
    }
